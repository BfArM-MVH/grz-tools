...
def upgrade() -> None:
    ...
    with op.batch_alter_table("submission_change_requests") as batch_op:
        batch_op.add_column(sa.Column("requester_name", AutoString(), nullable=False))
        batch_op.add_column(sa.Column("requester_email", AutoString(), nullable=False))
        batch_op.add_column(sa.Column("requested_at", sa.Date(), nullable=False))
        ...
        batch_op.create_check_constraint(
            "chk_change_request_content_present",
