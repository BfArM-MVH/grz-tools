...
from ...constants import REDACTED_TAN, TQDM_DEFAULTS
from ...models.s3 import S3Options
from ...progress import FileProgressLogger, UploadState
from ...transfer import init_s3_client
from ...workers.upload import MULTIPART_MAX_CHUNKS, MULTIPART_THRESHOLD, UploadError, UploadWorker, log
...
class S3BotoUploadWorker(UploadWorker):
    ...
    def upload_file(self, local_file_path: str | PathLike, s3_object_id: str):
        ...
        with tqdm(total=filesize, desc="UPLOAD  ", **TQDM_DEFAULTS, postfix=f"{s3_object_id}") as progress_bar:  # type: ignore[call-overload]
