...
def test_crypt4gh_encrypt_file(
    ...
    Crypt4GH.encrypt_file(temp_small_file_path, tmp_encrypted_file, crypt4gh_grz_public_keys, show_progress=False)

    private_key = Crypt4GH.retrieve_private_key(crypt4gh_grz_private_key_file_path)

    Crypt4GH.decrypt_file(tmp_encrypted_file, tmp_decrypted_file, private_key=private_key, show_progress=False)
